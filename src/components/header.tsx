    ...
    return (
      <div id="header" className="header">
        <div className="inner-flex">
          ...
          <button type="button" className="header-menu-button" id="js-menu-button">
            <svg aria-hidden="true" focusable="false" className="" width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><path d="M2 4v2h26v-2h-26zm0 12h26v-2h-26v2zm0 10h26v-2h-26v2z"></path></svg>
      
            Menu
          </button>

          <div className="header-utility header-utility-closed" id="js-header-utility">
