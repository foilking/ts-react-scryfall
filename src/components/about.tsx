    ...
    return (
        <div className="reference-doc">
            <button className="reference-doc-menu-expander" data-component="reference-doc-menu-expander">
                <span>Help Pages <svg aria-hidden="true" focusable="false" className="" width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><path fill="#5822AC" d="M27 9.375l-12 12.625-12-12.562 1.406-1.438 10.594 11.094 10.563-11.094z"></path></svg>
                </span>
            </button>
            ...
            <div className="reference-doc-menu collapsed">
                ...
                <ul>
                    <li><a href="https://scryfall.com/docs/api"><svg aria-hidden="true" focusable="false" className="" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"><path d="M11.625 4L0 15l11.625 11L13 24.563 2.906 15 13 5.438 11.625 4zm6.75 0L17 5.438 27.094 15 17 24.563 18.375 26 30 15 18.375 4z"></path></svg>
                        API Reference</a></li>
                </ul>
