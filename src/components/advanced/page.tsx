                ...
                <div className="inner-flex">
                    ...
                    <div className="form-row">
                        ...
                        <label className="form-row-label" htmlFor="flavor">
                            <svg aria-hidden="true" focusable="false" className="" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"><path d="M3 2v26h24v-26h-24zm4 24h-2v-22h2v22zm18 0h-16v-22h16v22zm-2-18h-12v2h12v-2zm0 4h-12v2h12v-2z"></path></svg>
                            Flavor Text
                        </label>
                        <div className="form-row-content">
